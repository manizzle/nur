"""Tests for oombra.feeds — threat intelligence feed scraping."""
...
class TestIngestToServer:
    @patch("oombra.feeds.urllib.request.urlopen")
...
def _parse_with_fixture(scraper_fn, raw_data: str) -> list[dict]:
    ...
    with patch("oombra.feeds._fetch", return_value=raw_data):
