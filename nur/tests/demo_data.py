"""
Demo data generator for nur — realistic threat intel for demos and testing.
...
Usage:
    python -m nur.tests.demo_data --output demo/
    # Generates JSON files ready for `nur upload` or `nur preview`
"""
