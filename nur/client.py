...
Platform-agnostic: point api_url at whatever ingests the nur wire format.
...
_RECEIPTS_DIR = Path.home() / ".nur" / "receipts"
...
class Client:
    ...
    def __init__(self, api_url: str, api_key: str | None = None):
        ...
        self.api_key = api_key or os.getenv("NUR_API_KEY")
